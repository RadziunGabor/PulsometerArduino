...
class Data(QDialog):
    ...
    def downloaddata(self):
        ...
        print(nowlogin)
        cur = conn.cursor()
        query1 = "select COUNT(value) from dbo.Pomiar inner join dbo.Dane_użytkownika on Pomiar.id_użytkownika = Dane_użytkownika.id_użytkownika where login like '" + nowlogin + "' and  data = '" + choosedata + "'"
        ...
        if count != 0:
            query2 = "select value from dbo.Pomiar inner join dbo.Dane_użytkownika on Pomiar.id_użytkownika = Dane_użytkownika.id_użytkownika where login like '" + nowlogin + "' and data = '" + choosedata + "'"
